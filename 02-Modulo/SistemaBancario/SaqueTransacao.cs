...
{
    public class SaqueTransacao : Transacao
    {
        ...
        public SaqueTransacao(Conta conta, decimal valor) : base(valor)
        {
            this.conta = conta;
            this.valor = valor;
        ...
        private void MostrarHistoricoTransacaoExecucao()
        {
            ...
            {
                historicoTransacao.AppendLine("Saque realizado com sucesso!");
